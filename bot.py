...
def main():
    ...
    app.add_handler(build_stats_conv())       # /stats + callbacks
    app.add_handler(build_today_conv())
    app.add_handler(build_mem_conv())
    app.add_handler(build_materials_conv())   # Materials: Books + Formulas + PYQs + Mix
    app.add_handler(build_formula_conv())     # direct formula_home access
